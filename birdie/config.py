...
from birdie.models import Category, OutputProfile, PostingMode, Tone, Window
...
class Config:
    ...
    default_tone: Tone = Tone.DEADPAN
...
def load_config(path: Path) -> Config:
    ...
    default_tone = Tone(str(raw.get("default_tone", "deadpan")))
