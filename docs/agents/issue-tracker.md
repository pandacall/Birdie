...
Issues and PRDs for this repo live as GitHub issues in `pandacall/Birdie`. Use the `gh` CLI
for all operations.

## Conventions

- **Create an issue**: `gh issue create --title "..." --body-file <path>` (heredoc for inline
  multi-line bodies).
